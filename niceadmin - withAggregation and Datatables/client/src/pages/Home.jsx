...
const Home = () => {
  ...
  return (
    <>
      <main>
        <section
          className="position-relative overflow-hidden pt-5 pt-lg-3"
          ...
          <div className="container">
            <div className="row align-items-center g-5">
              <div className="col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-5 mb-sm-0">
                ...
                Discover thousands of products across diverse categories, curated for quality and value. Join our community of 5M+ satisfied customers and enjoy seamless shopping from the comfort of your home
                </p>
              ...
              <div className="col-lg-7 col-xl-6 text-center position-relative">
                ...
                <div className="p-3 bg-success d-inline-block rounded-4 shadow-lg position-absolute top-50 end-0 translate-middle-y mt-n7 z-index-1 d-none d-md-block">
                  <p className="text-white">Our daily new deals</p>
      ...
      <div className="container">
		...
		<li className="nav-item me-2 me-sm-5">
              <button
                ...
                // aria-selected={selectedCategory === ele}
          ...
          {getCategory.map((ele, index) => (
            <li className="nav-item me-2 me-sm-5" key={ele._id}>
              <button
                className={`nav-link mb-2 mb-md-0 ${selectedCategory === ele ? 'active' : ''}`}
                id={`course-pills-tab-${index}`}
                data-bs-toggle="pill"
                data-bs-target={`#course-pills-tabs-${index}`}
                type="button"
        ...
        <ProductDis selectedCategory={selectedCategory} />
      </div>
    </section> */}
        ...
        <section>
          <div className="container">
            <div className="row mb-4">
              <div className="col-lg-8 mx-auto text-center">
                <h2 className="fs-1">Most Popular Products</h2>
                <p className="mb-0">
            ...
            >
              <li className="nav-item me-2 me-sm-5">
                <button
                  ...
                  id="course-pills-tab-all"
                  data-bs-toggle="pill"
                  data-bs-target="#course-pills-tabs-all"
                  type="button"
                  role="tab"
                  aria-controls="course-pills-tabs-all"
        ...
        <section className="pb-5 pt-0 pt-lg-5">
          <div className="container">
            <div className="row mb-4">
              <div className="col-lg-8 mx-auto text-center">
                <h2 className="fs-1">Our Trending deals</h2>
                <p className="mb-0">Check out most 🔥 products in the market</p>
              </div>
            </div>
            <div className="row">
                      ...
                      <div className="card-body pb-0">
                        ...
                        <div className="hstack gap-3">
                          <span className="h6 fw-light mb-0">
                            <i className="far fa-clock text-danger me-2"></i>6h
                            56m
                          </span>
                          <span className="h6 fw-light mb-0">
                            <i className="fas fa-table text-orange me-2"></i>82
                            lectures
                          </span>
                        </div>
                      </div>
                  ...
                  <div>
                    <div className="card action-trigger-hover border bg-transparent">
                      ...
                      <div className="card-body pb-0">
                        ...
                        <div className="hstack gap-3">
                          <span className="h6 fw-light mb-0">
                            <i className="far fa-clock text-danger me-2"></i>24h
                            56m
                          </span>
                          <span className="h6 fw-light mb-0">
                            <i className="fas fa-table text-orange me-2"></i>55
                            lectures
                          </span>
                        </div>
                      </div>
                  ...
                  <div>
                    <div className="card action-trigger-hover border bg-transparent">
                      ...
                      <div className="card-body pb-0">
                        ...
                        <div className="hstack gap-3">
                          <span className="h6 fw-light mb-0">
                            <i className="far fa-clock text-danger me-2"></i>09h
                            56m
                          </span>
                          <span className="h6 fw-light mb-0">
                            <i className="fas fa-table text-orange me-2"></i>21
                            lectures
                          </span>
                        </div>
                      </div>
