							...
							<form onSubmit={handleSubmit}>
								...
								<div class="mb-4">
									...
									<div class="input-group input-group-lg">
										...
										<input type="email" class="form-control border-0 bg-light rounded-end ps-1" onChange={handleChange} placeholder="E-mail" name='email' value={user.email} id="exampleInputEmail1"/>
									</div>
								</div>
								...
								<div class="mb-4">
									...
									<div class="input-group input-group-lg">
										...
										<input type="password" class="form-control border-0 bg-light rounded-end ps-1" onChange={handleChange} placeholder="password" name='password' value={user.password} id="inputPassword5"/>
									</div>
